...
// #include "src/managers/managePatients.h"
// #include "src/managers/manageOwners.h"
// #include "src/managers/manageTreatments.h"
// #include "src/managers/manageAppointments.h"
...
void mostrarReportes() {
    ...
    do {
        ...
        cout << "================================\n";
        cout << "1. Todos los pacientes\n";
        cout << "2. Citas por día\n";
        cout << "3. Tratamientos por paciente\n";
        cout << "0. Volver al menú principal\n";
        cout << "--------------------------------\n";
        cout << "Seleccione una opción: ";
        cin >> opcion;
        ...
        switch (opcion) {
            ...
            case 2:
                system("clear");
                cout << "\n[Mostrando citas por día...]\n";
                // mostrarCitasPorDia();
                break;
            case 3:
                system("clear");
                cout << "\n[Mostrando tratamientos por paciente...]\n";
                // mostrarTratamientosPorPaciente();
                break;
            case 0:
                system("clear");
                repetir = false;
